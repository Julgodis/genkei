use crate::{ColorValue, FloatQuantized, Str, StyleError, StyleOptions};
use std::str::FromStr;
...
impl FromStr for Color {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match s {
            ...
            "rose-50" => Ok(Self::Rose050),
            "rose-100" => Ok(Self::Rose100),
            "rose-200" => Ok(Self::Rose200),
            "rose-300" => Ok(Self::Rose300),
            "rose-400" => Ok(Self::Rose400),
            "rose-500" => Ok(Self::Rose500),
            "rose-600" => Ok(Self::Rose600),
            "rose-700" => Ok(Self::Rose700),
            "rose-800" => Ok(Self::Rose800),
            "rose-900" => Ok(Self::Rose900),
            "rose-950" => Ok(Self::Rose950),
            "pink-50" => Ok(Self::Pink050),
            "pink-100" => Ok(Self::Pink100),
            "pink-200" => Ok(Self::Pink200),
            "pink-300" => Ok(Self::Pink300),
            "pink-400" => Ok(Self::Pink400),
            "pink-500" => Ok(Self::Pink500),
            "pink-600" => Ok(Self::Pink600),
            "pink-700" => Ok(Self::Pink700),
            "pink-800" => Ok(Self::Pink800),
            "pink-900" => Ok(Self::Pink900),
            "pink-950" => Ok(Self::Pink950),
            "fuchsia-50" => Ok(Self::Fuchsia050),
            "fuchsia-100" => Ok(Self::Fuchsia100),
            "fuchsia-200" => Ok(Self::Fuchsia200),
            "fuchsia-300" => Ok(Self::Fuchsia300),
            "fuchsia-400" => Ok(Self::Fuchsia400),
            "fuchsia-500" => Ok(Self::Fuchsia500),
            "fuchsia-600" => Ok(Self::Fuchsia600),
            "fuchsia-700" => Ok(Self::Fuchsia700),
            "fuchsia-800" => Ok(Self::Fuchsia800),
            "fuchsia-900" => Ok(Self::Fuchsia900),
            "fuchsia-950" => Ok(Self::Fuchsia950),
            "purple-50" => Ok(Self::Purple050),
            "purple-100" => Ok(Self::Purple100),
            "purple-200" => Ok(Self::Purple200),
            "purple-300" => Ok(Self::Purple300),
            "purple-400" => Ok(Self::Purple400),
            "purple-500" => Ok(Self::Purple500),
            "purple-600" => Ok(Self::Purple600),
            "purple-700" => Ok(Self::Purple700),
            "purple-800" => Ok(Self::Purple800),
            "purple-900" => Ok(Self::Purple900),
            "purple-950" => Ok(Self::Purple950),
            "violet-50" => Ok(Self::Violet050),
            "violet-100" => Ok(Self::Violet100),
            "violet-200" => Ok(Self::Violet200),
            "violet-300" => Ok(Self::Violet300),
            "violet-400" => Ok(Self::Violet400),
            "violet-500" => Ok(Self::Violet500),
            "violet-600" => Ok(Self::Violet600),
            "violet-700" => Ok(Self::Violet700),
            "violet-800" => Ok(Self::Violet800),
            "violet-900" => Ok(Self::Violet900),
            "violet-950" => Ok(Self::Violet950),
            "indigo-50" => Ok(Self::Indigo050),
            "indigo-100" => Ok(Self::Indigo100),
            "indigo-200" => Ok(Self::Indigo200),
            "indigo-300" => Ok(Self::Indigo300),
            "indigo-400" => Ok(Self::Indigo400),
            "indigo-500" => Ok(Self::Indigo500),
            "indigo-600" => Ok(Self::Indigo600),
            "indigo-700" => Ok(Self::Indigo700),
            "indigo-800" => Ok(Self::Indigo800),
            "indigo-900" => Ok(Self::Indigo900),
            "indigo-950" => Ok(Self::Indigo950),
            "blue-50" => Ok(Self::Blue050),
            "blue-100" => Ok(Self::Blue100),
            "blue-200" => Ok(Self::Blue200),
            "blue-300" => Ok(Self::Blue300),
            "blue-400" => Ok(Self::Blue400),
            "blue-500" => Ok(Self::Blue500),
            "blue-600" => Ok(Self::Blue600),
            "blue-700" => Ok(Self::Blue700),
            "blue-800" => Ok(Self::Blue800),
            "blue-900" => Ok(Self::Blue900),
            "blue-950" => Ok(Self::Blue950),
            "sky-50" => Ok(Self::Sky050),
            "sky-100" => Ok(Self::Sky100),
            "sky-200" => Ok(Self::Sky200),
            "sky-300" => Ok(Self::Sky300),
            "sky-400" => Ok(Self::Sky400),
            "sky-500" => Ok(Self::Sky500),
            "sky-600" => Ok(Self::Sky600),
            "sky-700" => Ok(Self::Sky700),
            "sky-800" => Ok(Self::Sky800),
            "sky-900" => Ok(Self::Sky900),
            "sky-950" => Ok(Self::Sky950),
            "cyan-50" => Ok(Self::Cyan050),
            "cyan-100" => Ok(Self::Cyan100),
            "cyan-200" => Ok(Self::Cyan200),
            "cyan-300" => Ok(Self::Cyan300),
            "cyan-400" => Ok(Self::Cyan400),
            "cyan-500" => Ok(Self::Cyan500),
            "cyan-600" => Ok(Self::Cyan600),
            "cyan-700" => Ok(Self::Cyan700),
            "cyan-800" => Ok(Self::Cyan800),
            "cyan-900" => Ok(Self::Cyan900),
            "cyan-950" => Ok(Self::Cyan950),
            "teal-50" => Ok(Self::Teal050),
            "teal-100" => Ok(Self::Teal100),
            "teal-200" => Ok(Self::Teal200),
            "teal-300" => Ok(Self::Teal300),
            "teal-400" => Ok(Self::Teal400),
            "teal-500" => Ok(Self::Teal500),
            "teal-600" => Ok(Self::Teal600),
            "teal-700" => Ok(Self::Teal700),
            "teal-800" => Ok(Self::Teal800),
            "teal-900" => Ok(Self::Teal900),
            "teal-950" => Ok(Self::Teal950),
            "emerald-50" => Ok(Self::Emerald050),
            "emerald-100" => Ok(Self::Emerald100),
            "emerald-200" => Ok(Self::Emerald200),
            "emerald-300" => Ok(Self::Emerald300),
            "emerald-400" => Ok(Self::Emerald400),
            "emerald-500" => Ok(Self::Emerald500),
            "emerald-600" => Ok(Self::Emerald600),
            "emerald-700" => Ok(Self::Emerald700),
            "emerald-800" => Ok(Self::Emerald800),
            "emerald-900" => Ok(Self::Emerald900),
            "emerald-950" => Ok(Self::Emerald950),
            "green-50" => Ok(Self::Green050),
            "green-100" => Ok(Self::Green100),
            "green-200" => Ok(Self::Green200),
            "green-300" => Ok(Self::Green300),
            "green-400" => Ok(Self::Green400),
            "green-500" => Ok(Self::Green500),
            "green-600" => Ok(Self::Green600),
            "green-700" => Ok(Self::Green700),
            "green-800" => Ok(Self::Green800),
            "green-900" => Ok(Self::Green900),
            "green-950" => Ok(Self::Green950),
            "lime-50" => Ok(Self::Lime050),
            "lime-100" => Ok(Self::Lime100),
            "lime-200" => Ok(Self::Lime200),
            "lime-300" => Ok(Self::Lime300),
            "lime-400" => Ok(Self::Lime400),
            "lime-500" => Ok(Self::Lime500),
            "lime-600" => Ok(Self::Lime600),
            "lime-700" => Ok(Self::Lime700),
            "lime-800" => Ok(Self::Lime800),
            "lime-900" => Ok(Self::Lime900),
            "lime-950" => Ok(Self::Lime950),
            "yellow-50" => Ok(Self::Yellow050),
            "yellow-100" => Ok(Self::Yellow100),
            "yellow-200" => Ok(Self::Yellow200),
            "yellow-300" => Ok(Self::Yellow300),
            "yellow-400" => Ok(Self::Yellow400),
            "yellow-500" => Ok(Self::Yellow500),
            "yellow-600" => Ok(Self::Yellow600),
            "yellow-700" => Ok(Self::Yellow700),
            "yellow-800" => Ok(Self::Yellow800),
            "yellow-900" => Ok(Self::Yellow900),
            "yellow-950" => Ok(Self::Yellow950),
            "amber-50" => Ok(Self::Amber050),
            "amber-100" => Ok(Self::Amber100),
            "amber-200" => Ok(Self::Amber200),
            "amber-300" => Ok(Self::Amber300),
            "amber-400" => Ok(Self::Amber400),
            "amber-500" => Ok(Self::Amber500),
            "amber-600" => Ok(Self::Amber600),
            "amber-700" => Ok(Self::Amber700),
            "amber-800" => Ok(Self::Amber800),
            "amber-900" => Ok(Self::Amber900),
            "amber-950" => Ok(Self::Amber950),
            "orange-50" => Ok(Self::Orange050),
            "orange-100" => Ok(Self::Orange100),
            "orange-200" => Ok(Self::Orange200),
            "orange-300" => Ok(Self::Orange300),
            "orange-400" => Ok(Self::Orange400),
            "orange-500" => Ok(Self::Orange500),
            "orange-600" => Ok(Self::Orange600),
            "orange-700" => Ok(Self::Orange700),
            "orange-800" => Ok(Self::Orange800),
            "orange-900" => Ok(Self::Orange900),
            "orange-950" => Ok(Self::Orange950),
            "red-50" => Ok(Self::Red050),
            "red-100" => Ok(Self::Red100),
            "red-200" => Ok(Self::Red200),
            "red-300" => Ok(Self::Red300),
            "red-400" => Ok(Self::Red400),
            "red-500" => Ok(Self::Red500),
            "red-600" => Ok(Self::Red600),
            "red-700" => Ok(Self::Red700),
            "red-800" => Ok(Self::Red800),
            "red-900" => Ok(Self::Red900),
            "red-950" => Ok(Self::Red950),
            "stone-50" => Ok(Self::Stone050),
            "stone-100" => Ok(Self::Stone100),
            "stone-200" => Ok(Self::Stone200),
            "stone-300" => Ok(Self::Stone300),
            "stone-400" => Ok(Self::Stone400),
            "stone-500" => Ok(Self::Stone500),
            "stone-600" => Ok(Self::Stone600),
            "stone-700" => Ok(Self::Stone700),
            "stone-800" => Ok(Self::Stone800),
            "stone-900" => Ok(Self::Stone900),
            "stone-950" => Ok(Self::Stone950),
            "zinc-50" => Ok(Self::Zinc050),
            "zinc-100" => Ok(Self::Zinc100),
            "zinc-200" => Ok(Self::Zinc200),
            "zinc-300" => Ok(Self::Zinc300),
            "zinc-400" => Ok(Self::Zinc400),
            "zinc-500" => Ok(Self::Zinc500),
            "zinc-600" => Ok(Self::Zinc600),
            "zinc-700" => Ok(Self::Zinc700),
            "zinc-800" => Ok(Self::Zinc800),
            "zinc-900" => Ok(Self::Zinc900),
            "zinc-950" => Ok(Self::Zinc950),
            "gray-50" => Ok(Self::Gray050),
            "gray-100" => Ok(Self::Gray100),
            "gray-200" => Ok(Self::Gray200),
            "gray-300" => Ok(Self::Gray300),
            "gray-400" => Ok(Self::Gray400),
            "gray-500" => Ok(Self::Gray500),
            "gray-600" => Ok(Self::Gray600),
            "gray-700" => Ok(Self::Gray700),
            "gray-800" => Ok(Self::Gray800),
            "gray-900" => Ok(Self::Gray900),
            "gray-950" => Ok(Self::Gray950),
            "slate-50" => Ok(Self::Slate050),
            "slate-100" => Ok(Self::Slate100),
            "slate-200" => Ok(Self::Slate200),
            "slate-300" => Ok(Self::Slate300),
            "slate-400" => Ok(Self::Slate400),
            "slate-500" => Ok(Self::Slate500),
            "slate-600" => Ok(Self::Slate600),
            "slate-700" => Ok(Self::Slate700),
            "slate-800" => Ok(Self::Slate800),
            "slate-900" => Ok(Self::Slate900),
            "slate-950" => Ok(Self::Slate950),

            _ => Err(StyleError::InvalidSimpleColor(s.into())),
        }
    }
}

impl ColorValue for Color {
