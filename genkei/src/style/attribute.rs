...
pub trait Styleable: Sized {
    ...
    fn style_raw(self, style: Style) -> Self;

    /// Add multiple styles without preprocessing.
    fn styles_raw(self, styles: impl IntoIterator<Item = Style>) -> Self;
    ...
    #[inline]
    fn focus_style(self, style: impl Into<Style>) -> Self {
        self.style(State::focus(style))
    }

    /// Add styles for when the element is focused.
    fn focus(self, style: impl FnOnce(StyleBuilder) -> StyleBuilder) -> Self {
        self.styles(
            style(StyleBuilder::new())
                .build()
                .into_iter()
    ...
    #[inline]
    fn focus_visible_style(self, style: impl Into<Style>) -> Self {
        self.style(State::focus_visible(style))
    }

    /// Add styles for when the element is focus-visible.
    fn focus_visible(self, style: impl FnOnce(StyleBuilder) -> StyleBuilder) -> Self {
        self.styles(
            style(StyleBuilder::new())
                .build()
                .into_iter()
    ...
    #[inline]
    fn active_style(self, style: impl Into<Style>) -> Self {
        self.style(State::active(style))
    }

    /// Add styles for when the element is active.
    fn active(self, style: impl FnOnce(StyleBuilder) -> StyleBuilder) -> Self {
        self.styles(
            style(StyleBuilder::new())
                .build()
                .into_iter()
